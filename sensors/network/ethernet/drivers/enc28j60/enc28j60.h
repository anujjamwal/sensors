 ...
 * enc28j60.h
 *
 * Created: 10/13/2013 12:13:01 AM
 *  Author: anujjamwal
 */
...
#define RXSTART_INIT    0x0FFF  // give TX buffer half space ( 4KB )
...
uint8_t enc28j60ReadOp(uint8_t operation, uint8_t address);
void enc28j60WriteOp(uint8_t operation, uint8_t address, uint8_t data);
